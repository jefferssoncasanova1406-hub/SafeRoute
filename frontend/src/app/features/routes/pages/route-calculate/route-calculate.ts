...
export class RouteCalculatePage implements AfterViewInit, OnDestroy {
  ...
  protected readonly mapConfigurationError = signal<string | null>(null);
  ...
  async ngAfterViewInit(): Promise<void> {
    ...
    if (!appRuntimeConfig.mapboxPublicToken.trim()) {
      this.mapConfigurationError.set(
        'Configura mapboxPublicToken en runtime-config.js para habilitar el mapa.',
      );
      return;
    }
